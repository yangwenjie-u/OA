...
function loadData(page) {
    ...
    var fzList = optStatus.split("|");
    var col_fz = fzList[0];
    var val_fz = fzList.length > 1 ? fzList[1] : "";
    //清除
    optStatus = "";
    //请求数据
    $.ajax({
        ...
        dataType: "json",
        data: { col: col, val: val, col_fz: col_fz, val_fz: val_fz, helplink: ControlBase64Str(helplink), page: page, rows: rows, sort: sort, order: order },
        async: true,
