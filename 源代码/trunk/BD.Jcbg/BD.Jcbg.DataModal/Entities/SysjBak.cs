...
namespace BD.Jcbg.DataModal.Entities
{
	...
	/// <summary>
	/// ISysjBak interface for NHibernate mapped table 'SYSJ_BAK'.
	/// </summary>
	public interface ISysjBak
	{
	...
	/// <summary>
	/// SysjBak object for NHibernate mapped table 'SYSJ_BAK'.
	/// </summary>
	[Serializable]
	public class SysjBak : ICloneable,ISysjBak
	{
		...
		public SysjBak(string pDepCode, string pCsylb, decimal? pNsylb, decimal? pXz, string pWtbh, string pZh, string pSyr, string pSyfhr, DateTime? pSyrq, decimal? pQycs, string pSbmcbh, string pBeizhu, string pSysj1, string pSysj2, string pSysj3, string pSysj4, string pSysj5, string pSysj6, string pSysj7, string pSysj8, string pSysj9, string pSysj10, string pSysj11, string pSysj12, string pSysj13, string pSysj14, string pSysj15, string pSysj16, string pSysj17, string pSysj18, string pSysj19, string pSysj20, string pSysj21, string pSysj22, string pSysj23, string pSysj24, string pSysj25, string pSysj26, string pSysj27, string pSysj28, string pSysj29, string pSysj30, string pSysj31, string pSysj32, string pSysj33, string pSysj34, string pSysj35, string pSysj36, string pSysj37, string pSysj38, string pSysj39, string pSysj40, string pSysj41, string pSysj42, string pSysj43, string pSysj44, string pSysj45, string pSysj46, string pSysj47, string pSysj48, string pSysj49, string pSysj50, string pSysj51, string pSysj52, string pSysj53, string pSysj54, string pSysj55, string pSysj56, string pSysj57, string pSysj58, string pSysj59, string pSysj60, string pDataList, string pUniqCode, string pMaxKn, string pVideoFile, DateTime? pSyksrq, string pBlockList, bool? pIsComplete)
		{
			...
			this._blocklist = pBlockList; 
			this._iscomplete = pIsComplete; 
		}
		
		public SysjBak(int pRecid)
		{
			this._recid = pRecid; 
		}
		...
		public virtual string MaxKn
		{
			get { return _maxkn; }
			set 
			{
			  if (value != null && value.Length > 100)
			    throw new ArgumentOutOfRangeException("MaxKn", "MaxKn value, cannot contain more than 100 characters");
			  _bIsChanged |= (_maxkn != value); 
			  _maxkn = value; 
			}
		...
		public virtual string VideoFile
		{
			...
			{
			  if (value != null && value.Length > 100)
			    throw new ArgumentOutOfRangeException("VideoFile", "VideoFile value, cannot contain more than 100 characters");
		...
		public virtual string BlockList
		{
			get { return _blocklist; }
			set 
			{
			  if (value != null && value.Length > 100)
			    throw new ArgumentOutOfRangeException("BlockList", "BlockList value, cannot contain more than 100 characters");
			  _bIsChanged |= (_blocklist != value); 
			  _blocklist = value; 
			}
		...
		public virtual bool? IsComplete
		{
			...
			set { _bIsChanged |= (_iscomplete != value); _iscomplete = value; }
	...
	#region Custom ICollection interface for SysjBak 

	
	public interface ISysjBakCollection : ICollection
	{
		SysjBak this[int index]{	get; set; }
		void Add(SysjBak pSysjBak);
		void Clear();
	}
	
	[Serializable]
	public class SysjBakCollection : ISysjBakCollection
	{
		private IList<SysjBak> _arrayInternal;

		public SysjBakCollection()
		{
			_arrayInternal = new List<SysjBak>();
		}
		
		public SysjBakCollection( IList<SysjBak> pSource )
		{
		...
		public void CopyTo(Array array, int index){ _arrayInternal.CopyTo((SysjBak[])array, index); }
		public IEnumerator GetEnumerator() { return _arrayInternal.GetEnumerator(); }
		public void Add(SysjBak pSysjBak) { _arrayInternal.Add(pSysjBak); }
		public void Clear() { _arrayInternal.Clear(); }
		public IList<SysjBak> GetList() { return _arrayInternal; }
	 }
