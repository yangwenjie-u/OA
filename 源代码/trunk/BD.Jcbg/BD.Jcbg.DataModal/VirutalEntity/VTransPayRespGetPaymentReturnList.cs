...
{
    public class VTransPayRespGetPaymentReturnList:VTransPayRespBase
    {
        public VTransPayRespGetPaymentReturnListItem[] data { get; set; }
    }

    public class VTransPayRespGetPaymentReturnListItem
    {
        public string PaymentReturn { get; set; }
