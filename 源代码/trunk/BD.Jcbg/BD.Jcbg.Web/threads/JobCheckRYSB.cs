...
namespace BD.Jcbg.Web.threads
{
    ...
    /// 定时校验人员社保
    /// </summary>
    public class JobCheckRYSB : ISchedulerJob
    {
        ...
        public void Execute()
        {
            SysLog4.WriteError("开始线程JobCheckRYSB");
            while (true)
            {
                try
                {
                    ...
                    #region 校验技术负责人
                    string sql = "select top " + topnum.ToString() + " * from view_i_s_qy_jsfzr "+ " where ( SBLASTUPDATETIME is null or dateadd(day," + days.ToString() + ",SBLASTUPDATETIME) < getdate())" + " order by recid desc";
                    ...
                    #region 校验注册建造师
                    lsql.Clear();
                    sql = "select top " + topnum.ToString() + " * from view_i_s_qy_zcjzs " + " where ( SBLASTUPDATETIME is null or dateadd(day," + days.ToString() + ",SBLASTUPDATETIME) < getdate())" + "   order by recid desc ";
                    ...
                    #region 校验中级以上职称人员
                    lsql.Clear();
                    sql = "select top " + topnum.ToString() + " * from view_i_s_qy_zjyszcry " + " where ( SBLASTUPDATETIME is null or dateadd(day," + days.ToString() + ",SBLASTUPDATETIME) < getdate())" + "   order by recid desc ";
                    dt = CommonService.GetDataTable(sql);
                    ...
                    #region 校验现场管理人员
                    lsql.Clear();
                    sql = "select top " + topnum.ToString() + " * from view_i_s_qy_xcglry  " + " where ( SBLASTUPDATETIME is null or dateadd(day," + days.ToString() + ",SBLASTUPDATETIME) < getdate())" + "   order by recid desc";
                    dt = CommonService.GetDataTable(sql);
                    ...
                    #region 校验技术工人
                    lsql.Clear();
                    sql = "select top " + topnum.ToString() + " * from view_i_s_qy_jsgr  " + " where ( SBLASTUPDATETIME is null or dateadd(day," + days.ToString() + ",SBLASTUPDATETIME) < getdate())" + " order by recid desc";
                    dt = CommonService.GetDataTable(sql);
