...
$("#enginner_dqry").click(function(event) {
    try {
        window.parent.openPage("/kqj/currentworker", "GCGL_DQRY", "当前在岗人员");
    } catch (e) {
        console.log(e);
    }
});
$("#enginner_QYGL").click(function(event) {
    try {
        ...
        window.parent.openPage("/WebList/EasyUiIndex?FormDm=QYGL_GCRYBA&FormStatus=0", "QYGL_GCRYBA", "实名制登记");
    } catch (e) {
        console.log(e);
    }
});
$("#enginner_sbyc").click(function (event) {
    try {
        ...
        window.parent.openPage("/WebList/EasyUiIndex?FormDm=I_M_KQJ&FormStatus=0", "QYGL_KQJ", "异常设备查看");
    } catch (e) {
        console.log(e);
    }
}); 
$("#enginner_kqyc").click(function (event) {
    try {
        ...
        window.parent.openPage("/WebList/EasyUiIndex?FormDm=KQYC_RY&FormStatus=0", "KQYC_RY", "考勤异常查看");
    } catch (e) {
        console.log(e);
    }
});
...
// 工种数
function GetGzRynum() {
    ajaxTpl("/wzwgry/GetGzRynum", "", function(data) {
        enginner1(data);
        enginner2(data);
        enginner3(data);
        enginner4(data);
...
function getInfo_GC() {
    ajaxTpl("/wzwgry/getInfo_GC", "", function(data) {
