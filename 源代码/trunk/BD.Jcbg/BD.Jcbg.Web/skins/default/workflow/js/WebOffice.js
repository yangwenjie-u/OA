function WebOffice2015() {
    ...
    */
    ...
    this.WebSaveWithSerial = function (serialno) {
    	var httpclient = this.obj.Http; //设置http对象 
    	httpclient.Clear();
    	this.WebSetMsgByName("USERNAME", this.UserName);
    	this.WebSetMsgByName("RECORDID", this.RecordID);
    	this.WebSetMsgByName("SERIALNO", serialno);
    	this.WebSetMsgByName("OPTION", "SAVEFILE");
    	this.WebSetMsgByName("FILENAME", this.FileName); //加载FileName
    	var path = this.getFilePath() + this.FileName;
    	this.WebSaveLocalFile(path);
    	this.Close();
    	if (this.SAVEFILE(httpclient, path)) {
    		this.Status = "保存文件成功";
    		return true;
    	}
    	this.Status = "保存文件失败";
  ...
  //光标处添加书签
    ...
    */
    ...
    this.setColor = function (typeColor) {   //设置边框演示
        ...
        switch (typeColor) {
            case "purple": titleBarColor = 0xCC99CC; menuBarStartColor = 0xCC99CC; menuBarButtonStartColor = 0xFFFFFF; menuBarButtonEndColor = 0xAD8DAD; menuBarButtonFrameColor = 0x663366; break;
            case "black": titleBarColor = 0x646464; menuBarStartColor = 0xB7B5B4; menuBarButtonStartColor = 0xF2EAF5; menuBarButtonEndColor = 0xF2EAF5; menuBarButtonFrameColor = 0xF2EAF5; break;
            case "white": titleBarColor = 0xC6C1BE; menuBarStartColor = 0xF5F3F2; menuBarButtonStartColor = 0xF2EAF5; menuBarButtonEndColor = 0xF2EAF5; menuBarButtonFrameColor = 0xF2EAF5; break;
            case "blue": titleBarColor = 0xD5B69F; menuBarStartColor = 0xFCF3EF; menuBarButtonStartColor = 0xF2EAF5; menuBarButtonEndColor = 0xF2EAF5; menuBarButtonFrameColor = 0xF2EAF5; break;
            case "yellow": titleBarColor = 0x00CCFF; menuBarStartColor = 0x6AB9FF; menuBarButtonStartColor = 0xF2EAF5; menuBarButtonEndColor = 0xF2EAF5; menuBarButtonFrameColor = 0xF2EAF5; break;
        }
        var style = this.obj.Style;
