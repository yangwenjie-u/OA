...
//	alert(field.length);
	...
	*/
	...
	if(dayg_live==false)
	{
		if(field.length>conditionNum)
	{
    ret_s += "<div class=\"table_wai\"><table class='stj_lr_tab' style='width:"+(conditionNum*360)+"px;min-width:730px;' >";
	//table_width=conditionNum*450;
	//alert(field.length);
	}
	else
	{
		 ...
		 ret_s += "<div class=\"table_wai\"><table class='stj_lr_tab' style='width:"+(field.length*360)+"px;min-width:730px;' >";
		// table_width=field.length*450;
		}
	...
	else
	{
		 ...
		 ret_s += "<div class=\"table_wai\"><table class='stj_lr_tab' style='width:"+((field.length-1)*360)+"px;min-width:730px;' >";
		// table_width=field.length*450;
		}
...
function GetT3Tab(tablab,table, sy, rec, syfield,t3limit) {
    ...
    html += "<div class=\"tabs-container\">";
	 ...
	 if (dataReadonly || t3limit == "1") 
	    ...
	    html += "<div class='btn-group'>";
     html += " <button type=\"button\" class=\"btn btn-default btn-sm\" id=\"" + table + "_" + rec + "btn\" name=\"" + table + "_" + rec + "btn\"  onclick=\"AddT3Page('" + tablab + "','" + table + "','" + sy + "'," + rec + ",'" + syfield + "','" + t3limit  + "');\"><i class=\"fa fa-plus\"></i>添加</button>";
     html += " <button type=\"button\" class=\"btn btn-default btn-sm\" id=\"" + table + "_" + rec + "CopyBtn\" name=\"" + table + "CopyBtn\"    onclick=\"CopyT3Page('" + tablab + "','" + table + "','" + sy + "'," + rec + ",'" + syfield + "','" + t3limit + "');\"> <i class='fa fa-copy'> </i>复制</button>";
