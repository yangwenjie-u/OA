...
function edit() {
    try {
        ...
        var buttons = encodeURIComponent("提交申请|TJ| | |申请成功"); // 按钮
...
<<<<<<< .mine
                    ...
                    var js = encodeURIComponent("qyService.js");
                    var callback = encodeURIComponent("qyService.addroleforqy('$$ZZBH$$')");
||||||| .r98
                    var sufproc = encodeURIComponent("QYZZSPSendMail|$JYDBH$|" + qybh + "|1");
					var js=encodeURIComponent("smsService.js");
                    var callback = encodeURIComponent("smsService.setSMSTZ('qyzzsp')");
=======
                    var sufproc = encodeURIComponent("QYZZSPSendMail|$JYDBH$|"+qybh+"|1");
>>>>>>> .r220
                    var rdm = Math.random();
