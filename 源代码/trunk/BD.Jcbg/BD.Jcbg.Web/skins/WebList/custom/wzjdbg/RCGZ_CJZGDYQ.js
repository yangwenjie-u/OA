function selectGc() {
    try {
        ...
        var parentserial = selected.WorkSerial;
        var bcode = new Base64();
        var title = selected.GCMC;
        var extrainfo1 = bcode.encode("view_i_m_gc|" + bcode.encode("gcbh='" + gcbh + "'") + "||" + "view_jdbg_jdjl|" + bcode.encode("workserial='" + parentserial + "'"));
