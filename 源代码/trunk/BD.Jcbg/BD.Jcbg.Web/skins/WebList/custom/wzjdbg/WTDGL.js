            ...
            success: function (data) {
                try {
                    if (data.code == 0) {                    
                        ...
                        var s_title = encodeURIComponent("从表记录");
        ...
        if (!g_dlgClose) {
            ...
            if (g_curPrintIndex >= g_prints.length) {
                ...
                parent.layer.open({
                    ...
                    shade: 0.8,
                    area: ['100%', '100%'],
                    content: "/jc/printwts?syxmbh=" + encodeURIComponent(curitem.SYXMBH) + "&recid=" + encodeURIComponent(curitem.RECID),
                    end: function () {
                        g_dlgClose = true;
                    }
                });
