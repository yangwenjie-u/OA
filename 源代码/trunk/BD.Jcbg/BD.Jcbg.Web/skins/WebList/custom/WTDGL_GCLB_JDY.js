function addWtdJdy() {
    try {
        ...
        parent.layer.open({
            ...
            shade: 0.5,
            area: ['500px', '150px'],
            content: "/jc/jcjgxzjdy?gcbh=" + encodeURIComponent(selected.GCBH),
            btn: ["确定", "取消"],
            yes: function (index) {
                ...
                parent.layer.open({
                    ...
                    shade: 0.5,
                    area: ['98%', '98%'],
                    content: "/jc/syxmxzjdy?gcbh=" + encodeURIComponent(selected.GCBH) + "&gcmc=" + encodeURIComponent(selected.GCMC) + "&dwbh=" + encodeURIComponent(qybh),
                });
            },
