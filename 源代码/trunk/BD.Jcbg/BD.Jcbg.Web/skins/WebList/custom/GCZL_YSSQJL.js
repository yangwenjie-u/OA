function view() {
    try {
        ...
        if (reportfile == null || reportfile == "" || serial == null || serial=="") {
			...
			var reportype = selected.YSSQLX == 'JGYSSQ' ? 'JGYSSQJL' : 'YSSQJL';
            parent.parent.layer.open({
                ...
                shade: 0.8,
                area: ['95%', '95%'],
                content: "/jdbg/flowreport?reportfile=" + encodeURIComponent(reportfile) + "&serial=" + encodeURIComponent(serial)+ "&reportype=" + reportype,
                end: function () {
                    searchRecord();
                }
            });
