function add() {
    try{
        var url = "/workflow/startwork?processid=7&DlgId=1&_=" + Math.random();
        parent.layer.open({
            type: 2,
            title: '',
            shadeClose: true,
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code != "0") {
                ...
                var url = "/workflow/startwork?processid=2&DlgId=1&extrainfo=" + encodeURIComponent(extrainfo1) +"&_=" + Math.random();
                parent.layer.open({
                    type: 2,
                    title: '',
                    shadeClose: true,
...
function del() {
    try {
        ...
        var bcode = new Base64();
        var extrainfo1 = bcode.encode("i_m_ht|" + bcode.encode("recid=" + selected.Recid + ""));
        var url = "/workflow/startwork?processid=3&DlgId=1&extrainfo=" + encodeURIComponent(extrainfo1) + "&ParentSerial="+encodeURIComponent(selected.SerialNo)+"&_=" + Math.random();
        parent.layer.open({
            type: 2,
            title: '',
            shadeClose: true,
