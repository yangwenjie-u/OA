    ...
    try {
        ...
        if (reportfile != "" && serial!="") {
            parent.layer.open({
                ...
                shade: 0.8,
                area: ['95%', '95%'],
                content: "/jdbg/flowreport?reportfile=" + encodeURIComponent(reportfile) + "&serial=" + encodeURIComponent(serial) + "&print=" + encodeURIComponent(isprint) + "&reporttype=FWJ",
                end: function () {
                }
            });
        }
    ...
    try {
        ...
        if (serial !="") {
            parent.layer.open({
                ...
                shade: 0.8,
                area: ['95%', '95%'],
                content: "/dwgxwz/showfw?serial=" + encodeURIComponent(serial),
                end: function () {
                }
            });
        }
