function add() {
    try {
        var tabledesc = "证书分类";                // 表格描述
        var zdzdtable = encodeURIComponent("ZDZD_JC"); // zdzd名
        var tablename = encodeURIComponent("H_ZZZSFL"); 			// 表名
...
function del() {
    try {
        ...
        $.ajax({
            type: "POST",
            url: "/delete/deletehzzzsfl?recid=" + encodeURIComponent(selected.RECID),
            dataType: "json",
            async: false,
