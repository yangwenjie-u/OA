                ...
                if (obj == "") {
                    ...
                    var processid = 0;
                     if (obj == "JGYS")
                        ...
                        processid = 57;
                    else if (obj == "JCFBYS" || obj == "ZTFBYS" || obj == "JGYYS" || obj == "FHYS")
                        processid = 14;
                    else
                        processid = 16;
                    var url = "/workflow/startwork?processid=" + processid + "&preurldone=true&yslx="+obj;

                    showCssz(selected.GCBH, url);
                }
...
function showCssz(gcbh, workurl) {
    try{
        $.ajax({
            type: "POST",
            url: "/jdbg/getgccs",
        ...
        if (multiFgc) {
            ...
            parent.layer.open({
                ...
                yes: function (index) {
                    ...
                    gotoStarkWork(workurl, extrainfo1, extrainfo2, extrainfo3, extrainfo4, obj.fgcmc);
                },
                success: function (layero, index) {
                    layerObj = layero;
                },
            ...
            gotoStarkWork(workurl, extrainfo1, extrainfo2, extrainfo3, "", "");
    }
    catch (err) {
        alert(err);
    }
}
function gotoStarkWork(workurl, extrainfo1, extrainfo2, extrainfo3, extrainfo4, fgcmc, otherparams) {
    try {
        var rdm = Math.random();
        var url = workurl +
            // 加密的条件信息（表单中用到）
