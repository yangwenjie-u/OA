...
if ($.fn.datebox){
    ...
    $.fn.datebox.defaults.customizedCurrentText = '今天';
...
if ($.fn.datagrid && $.fn.datagrid.defaults && $.fn.datagrid.defaults.operators.nofilter) {
    ...
    $.fn.datagrid.defaults.operators.beginwith.text = "匹配开头";
    $.fn.datagrid.defaults.operators.endwith.text = "匹配结尾";
    ...
    $.fn.datagrid.defaults.operators.range.text = "区间";
}