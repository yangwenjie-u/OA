                    ...
                    if (value != '') {
                        if ((rule && rule.value != value) || !rule) {
                            $(target)[name]('addFilterRule', {
                                ...
                                op: !rule ? opts.defaultFilterOperator : rule.op,
                                value: value
                            });
        ...
        */
        function createFilter(frozen) {
            ...
            for (var i = 0; i < fields.length; i++) {
                ...
                var td;
                if (field == '_') {
                    td = $('<td style="text-align:center">\u68c0\u7d22</td>').attr('field', field).appendTo(tr);
                }
                else
...
//                        field: field,
//                        //op: opts.defaultFilterOperator,
//                        op: !fopts.defop ? opts.defaultFilterOperator : fopts.defop,
//                        value: ''
//                    });
                } else {
                    fopts = $.extend({}, {
