    ...
    public class BankInfo
    {
        ...
        public static string  GetBankName(char[] charBin, int offset = 0)
        {
            ...
            try
            {
                ...
                index = BinarySearch(BankBin, longBin);
            }
            catch(Exception e)
            {
                msg = e.Message;
        ...
        /// <returns></returns>
        public static bool IsHuaxiaCard(string cardno)
        {
            bool ret = false;
            if (string.IsNullOrEmpty(cardno))
                return ret;
            string bankInfo = GetBankName(cardno.ToCharArray());
            return bankInfo.IndexOf("华夏") > -1;
        }
        #endregion
        ...
        private static int BinarySearch(IList<long> srcArray, long des)
        {
            int low = 0;
