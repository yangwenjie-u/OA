...
{
    public class SmsServiceWgry : ISmsServiceWgry
    {
        #region 用到的Dao
       ...
       /// <summary>
        ...
        private string SmsBaseSettingDns //百度短信域名
        {
            get
            {
		...
		#region 通知短信  
        private string SmsMessageTemplateCode 
        {
             get
             {
                 return GetSysSettingValue("SMS_MESSAGE_SETTING_TEMPLATE_CODE");
             }
        }
        private string SmsMessageTemplateCodeV3  //版本V3
        {
            get{
        ...
        #endregion
        private string SmsBaseSettingUrl //百度短信网页
        {
            get { return GetSysSettingValue("SMS_BASE_SETTING_URL"); }
        }

        private string SmsBaseSettingInvokeId //百度短信签名标识
        {
            get { return GetSysSettingValue("SMS_BASE_SETTING_INVOKE_ID"); }
        }
		private string SmsBaseAppId //应用标识
        {
            get{
                return GetSysSettingValue("SMS_BASE_SETTING_APP_ID");
            }
        
        }
        private string SmsBaseSettingKeyId //百度密钥标识
        {
            get { return GetSysSettingValue("SMS_BASE_SETTING_KEY_ID"); }
        }
        private string SmsBaseSettingSecretKey //百度传输密钥
        {
        ...
        private string GetSmsMessageCompanyName2
        {
             get{
                 return GetSysSettingValue("SMS_MESSAGE_SETTING_COMPANY_NAME2");
            }  
        }
        /// <summary>
        /// 台州
        /// </summary>
        private string GetSmsMessageCompanyName_TZ
        {
            get
            {
                return GetSysSettingValue("SMS_MESSAGE_SETTING_COMPANY_NAME_TZ");
            }
        }
        #endregion
        ...
        public bool DoSendMessage(string phones,string content,string guid,string lx)
        {
            ...
            {             
                ...
                else
                {
                    ...
                    //if (lx == "QX")
                    //    companyname = GetSmsMessageCompanyName2;
                    //else if(lx=="TZ")
                    //    companyname = GetSmsMessageCompanyName_TZ;
                    //else
                     //   companyname = SmsMessageCompanyName;
